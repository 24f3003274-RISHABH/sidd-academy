...
/**
 * WHY: CORS Configuration (MOVED TO THE ABSOLUTE TOP)
 * Sanitizes trailing slashes automatically to prevent matching mismatches.
 */
const parseAllowedOrigins = () => {
  if (!ENV.CORS_ORIGIN || ENV.CORS_ORIGIN === '*') {
    return null;
  }
  // .replace(/\/$/, '') removes any accidental trailing slash from your env variables
...
// Explicitly handle and reply 200 OK directly to preflight OPTIONS requests before doing anything else
...
/**
 * WHY: Body Parsers & Security (NOW PLACED BELOW CORS)
 */
