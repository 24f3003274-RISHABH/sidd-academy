...
export const createClass = (data) => axiosInstance.post('/lessons', data);
export const updateClass = (id, data) => axiosInstance.put(`/lessons/${id}`, data);
export const deleteClass = (id) => axiosInstance.delete(`/lessons/${id}`);
export const getClassesByChapter = (chapterId) => axiosInstance.get('/lessons', { params: { chapterId } });
